...
<div class="row">
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">Gerar Relatório de Participantes</header>
                    ...
                    <form role="form" id="generateReport" method="POST">
                        <div class="filters">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cg_nome" placeholder="Filtre pelo nome do inscrito (Participante)">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Nome para crachá</label>
                                <input type="text" class="form-control" name="cg_nome_cracha" placeholder="Filtre pelo nome do crachá do inscrito (Participante)">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="cg_tratamento">
                                        <option value="">Selecione</option>
                                        <option value="1">Doutor</option>
                                        <option value="2">Doutora</option>
                                        <option value="3">Senhor</option>
                                        <option value="4">Senhora</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">Área de Atuação</label>
                                <div class="form-group">
                                    <select name="cg_area_profissional[]" class="multi-select" multiple id="my_multi_select3" style="position: absolute; left: -9999px;">
                                        <?php
                                        foreach($values as $value){
                                            echo "<option value='".$value->cg_area_profissional."'>".$value->cg_area_profissional."</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
